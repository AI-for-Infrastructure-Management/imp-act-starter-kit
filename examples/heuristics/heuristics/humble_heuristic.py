...
class HumbleHeuristic(Heuristic):
    ...
    def get_rollout(self, env, policy, verbose=False):
        ...
        while not done:
            ...
            actions = policy(obs['edge_observations'], current_time)
    ...
    def policy(self, edge_obs, current_time):
        
        replacement_threshold = self.rules_value['replacement_threshold'] 
        major_repair_threshold = self.rules_value['major_repair_threshold'] 
        minor_repair_threshold = self.rules_value['minor_repair_threshold'] 
        inspection_interval = self.rules_value['inspection_interval'] 
